        ...
        <div class="vote-options-row">
            <c:if test="${sessionScope.user != null}">
                <div class="thumbs-wrapper">
                    <i class="fas fa-2x fa-thumbs-up upvoteIcon margin-right-lt" ng-click="upVote(post.id)"
                       ng-class="{true:'upvoteActive', false:'upvoteIcon'}"></i>
                    <span class="margin-right-lt">{{post.voteCount}}</span>
                    <i class="fas fa-2x fa-thumbs-down downvoteIcon" ng-click="downVote(post.id)"
                       ng-class="{true:'downvoteActive', false:'downvoteIcon'}"></i>
                </div>
            </c:if>
